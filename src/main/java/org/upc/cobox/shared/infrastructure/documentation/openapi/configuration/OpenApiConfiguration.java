package org.upc.cobox.shared.infrastructure.documentation.openapi.configuration;
...
public class OpenApiConfiguration {
    ...
    private Info apiInfo() {
        return new Info()
                .title("Cobox API")
                .description("REST API documentation for Cobox, a personalized tourism platform.")
                .version("v1.0.0")
                .license(new License()
                        .name("Apache 2.0")
